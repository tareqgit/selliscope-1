...
public class LoadLocalIntoBackground {
    private com.easyopstech.easyops.utils.SessionManager sessionManager;
    private DatabaseHandler databaseHandler;
    private RootApiEndpointInterface apiService;
    private Context mContext;
    public LoadLocalIntoBackground(Context context) {
        mContext=context;
        this.sessionManager = new com.easyopstech.easyops.utils.SessionManager(context);
        this.databaseHandler = new DatabaseHandler(context);
        this.apiService = RootApplication.getRetrofitInstance(sessionManager.getUserEmail(), sessionManager.getUserPassword(), false).create(RootApiEndpointInterface.class);
    }
