 ...
 */
public class OutletBoundaryCallback extends PagedList.BoundaryCallback<OutletItem>  implements SelliscopeApplication.ApiCallback {
    ...
    private void requestAndSaveData(String query) {
        ...
        SelliscopeApplication.searchRepos(apiService, query, lastRequestedPage, NETWORK_PAGE_SIZE, this);
    }
