package com.sokrio.sokrio_classic.job_sheduler;
...
public class MyJobScheduler extends JobService {
    ...
    private void sendUserLocation(double latitude, double longitude, String timeStamp, final boolean fromDB, final int visitId) {
        ...
        userLocationVisits.add(new UserLocation.Visit(latitude, longitude, GetAddressFromLatLang.getAddressFromLatLan(getApplicationContext(), latitude, longitude), timeStamp, BatteryUtils.getBatteryLevelPercentage(context)));
