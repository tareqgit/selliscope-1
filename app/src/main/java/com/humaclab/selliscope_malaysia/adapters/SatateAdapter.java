...
public class SatateAdapter extends ArrayAdapter<Districts.Successful.District> {
    LayoutInflater layoutInflater;
    private Activity activity;
    private List<Districts.Successful.District> districts;

    public SatateAdapter(Activity activity, List<Districts.Successful.District>
            districts) {
