...
import com.humaclab.selliscope_kenya.model.Targets;
...
public class TargetRecyclerViewAdapter extends
    ...
    public class TargetViewHolder extends RecyclerView.ViewHolder {
        ...
        public TargetViewHolder(View itemView) {
            super(itemView);
            cardView = itemView.findViewById(R.id.cv_target_item);
            mCircleProgressView = itemView
                    .findViewById(R.id.circle_progress_view);
            targetLabel = itemView.findViewById(R.id.tv_target_label);
            targetAchieved = itemView.findViewById(R.id.tv_target_achieved);
            targetRemaining = itemView.findViewById(R.id.tv_target_remaining);
            targetTotal = itemView.findViewById(R.id.tv_target_total);
