...
import static com.easyopstech.easyops.activity.OrderActivity.selectedProductList;
...
import com.easyopstech.easyops.adapters.SelectedProductRecyclerAdapter;
import com.easyopstech.easyops.databinding.ActivityCartBinding;
import com.easyopstech.easyops.helper.SelectedProductHelper;
import com.easyopstech.easyops.model.AddNewOrder;
import com.easyopstech.easyops.pos_sdk.model.PosModel;
import com.easyopstech.easyops.sales_return.SalesReturn_2019_Activity;
...
public class ActivityCart extends AppCompatActivity implements  SelectedProductRecyclerAdapter.OnRemoveFromCartListener{
    ...
    void postSalesReturn(RootApiEndpointInterface apiService, int orderId, int outletId){
