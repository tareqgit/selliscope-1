...
public class CountyAdapter extends ArrayAdapter<Districts.Successful.District> {
    LayoutInflater layoutInflater;
    private Activity activity;
    private List<Districts.Successful.District> districts;

    public CountyAdapter(Activity activity, List<Districts.Successful.District>
            districts) {
